...
namespace UnityView.InputProviders
{
    public class UnityInputSystemPlayerInputProvider : MonoBehaviour, IPlayerInputProvider
    {
        ...
        [SerializeField] CinemachineInputProvider _cinemachineProvider;
        ...
        private void Awake()
        {
            moveSubject.AddTo(this);
            jumpSubject.AddTo(this);
            sprintSubject.AddTo(this);
        }
        ...
        {
            _isActive = active;
            _cinemachineProvider.enabled = active;
        }
